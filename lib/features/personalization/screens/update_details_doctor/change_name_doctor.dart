...
import 'package:races/features/personalization/controllers/update_controller_doctor/update_name_controller_doctor.dart';
...
class ChangeNameDoctor extends StatelessWidget {
  const ChangeNameDoctor({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(UpdateNameControllerDoctor());
    return Scaffold(
      //custom appbar
      appBar: SAppBar(
        showBackArrow: true,
