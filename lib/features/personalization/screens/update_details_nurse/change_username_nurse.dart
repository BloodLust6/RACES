...
import 'package:races/features/personalization/controllers/update_controller_nurse/update_username_controller_nurse.dart';
...
class ChangeUsernameNurse extends StatelessWidget {
  const ChangeUsernameNurse({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(UpdateUsernameControllerNurse());
    return Scaffold(
      //custom appbar
      appBar: SAppBar(
        showBackArrow: true,
