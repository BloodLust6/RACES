...
class ProfileScreenNurse extends StatelessWidget {
  const ProfileScreenNurse({super.key});
          ...
          child: Column(
            children: [
              ...
              SProfileMenu(
                ...
                onPressed: () => Get.toNamed(SRoutes.chgnameN),
              ),
              SProfileMenu(
                title: 'Username',
                value: controller.user.value.username,
                onPressed: () => Get.toNamed(SRoutes.chgusernameN),
              ),
              ...
              SProfileMenu(
                ...
                onPressed: () => Get.toNamed(SRoutes.chgphonenoN),
              ),
              SProfileMenu(
                title: 'Gender',
                value: controller.user.value.gender,
                onPressed: () => Get.toNamed(SRoutes.chggenderN),
              ),
              SProfileMenu(
                title: 'Date of Birth',
                value: controller.user.value.dob,
                onPressed: () => Get.toNamed(SRoutes.chgdobN),
              ),
              const Divider(),
              const SizedBox(height: SSizes.spaceBtwItems),
