...
import 'package:races/features/medication/screens/update_medication/update_medication.dart';
...
class MedicationBoxNurse extends StatelessWidget {
  const MedicationBoxNurse({
    super.key,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    icon: const Icon(Iconsax.tag_right),
                    onPressed: () => controller.recordWarningPopup(
                      uid: medication.uid,
                      id: medication.id,
                      medication: medication,
                    ),
