...
import 'package:races/features/personalization/controllers/update_controller_nurse/update_phonenumber_controller_nurse.dart';
...
class ChangePhoneNumberNurse extends StatelessWidget {
  const ChangePhoneNumberNurse({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(UpdatePhoneNumberControllerNurse());
    return Scaffold(
      //custom appbar
      appBar: SAppBar(
        showBackArrow: true,
