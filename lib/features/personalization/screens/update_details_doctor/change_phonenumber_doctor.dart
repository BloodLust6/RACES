...
import 'package:races/features/personalization/controllers/update_controller_doctor/update_phonenumber_controller_doctor.dart';
...
class ChangePhoneNumberDoctor extends StatelessWidget {
  const ChangePhoneNumberDoctor({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(UpdatePhoneNumberControllerDoctor());
    return Scaffold(
      //custom appbar
      appBar: SAppBar(
        showBackArrow: true,
