          ...
          child: Column(
            children: [
              ...
              SProfileMenu(
                ...
                onPressed: () => Get.toNamed(SRoutes.chgname),
              ),
              SProfileMenu(
                title: 'Username',
                value: controller.user.value.username,
                onPressed: () => Get.toNamed(SRoutes.chgusername),
              ),
              ...
              SProfileMenu(
                ...
                onPressed: () => Get.toNamed(SRoutes.chgphoneno),
              ),
              SProfileMenu(
                title: 'Gender',
                value: controller.user.value.gender,
                onPressed: () => Get.toNamed(SRoutes.chggender),
              ),
              SProfileMenu(
                title: 'Date of Birth',
                value: controller.user.value.dob,
                onPressed: () => Get.toNamed(SRoutes.chgdob),
              ),
              const Divider(),
              const SizedBox(height: SSizes.spaceBtwItems),
