...
import 'package:races/features/dependent/controllers/update_dependent_controller.dart';
...
class UpdateDependentScreen extends StatefulWidget {
  final String id;
  ...
  @override
  State<UpdateDependentScreen> createState() => _UpdateDependentScreenState();
}

class _UpdateDependentScreenState extends State<UpdateDependentScreen> {
  ...
  void onChanged(dynamic value) {
    final controller = Get.find<UpdateDependentController>();
    controller.gender.value = value;
  }

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(UpdateDependentController());

    // Set the text field controllers with the dependent details
    controller.name.text = widget.dependent.name;
    controller.gender.value = widget.dependent.gender;
    controller.dob.text = widget.dependent.dob;
    controller.relation.text = widget.dependent.relation;

    return Form(
      key: controller.updateDependentFormKey,
      child: Scaffold(
        appBar: SAppBar(
          showBackArrow: true,
          title: Text(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () =>
                        controller.updateDependent(widget.dependent.id),
