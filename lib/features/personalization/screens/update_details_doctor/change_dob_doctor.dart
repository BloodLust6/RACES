...
import 'package:races/features/personalization/controllers/update_controller_doctor/update_dob_controller_doctor.dart';
...
class ChangeDateOfBirthDoctor extends StatefulWidget {
  const ChangeDateOfBirthDoctor({super.key});

  @override
  State<ChangeDateOfBirthDoctor> createState() =>
      _ChangeDateOfBirthDoctorState();
}

class _ChangeDateOfBirthDoctorState extends State<ChangeDateOfBirthDoctor> {
  @override
  Widget build(BuildContext context) {
    final controller = Get.put(UpdateDateOfBirthControllerDoctor());
    return Scaffold(
      //custom appbar
      appBar: SAppBar(
        showBackArrow: true,
