...
import 'package:races/features/personalization/controllers/update_controller_doctor/update_username_controller_doctor.dart';
...
class ChangeUsernameDoctor extends StatelessWidget {
  const ChangeUsernameDoctor({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(UpdateUsernameControllerDoctor());
    return Scaffold(
      //custom appbar
      appBar: SAppBar(
        showBackArrow: true,
